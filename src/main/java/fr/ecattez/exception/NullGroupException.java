...
/**
 * Exception produite lorsqu'un utilisateur n'appartient à aucun groupe.
 */
public class NullGroupException extends RuntimeException {
	...
	public NullGroupException() {
		super("Un utilisateur doit forcément appartenir à un groupe (à minima le groupe par défaut)");
	}
